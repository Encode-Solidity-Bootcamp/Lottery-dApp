...
import {LOTTERY_CONTRACT,LOTTERY_TOKEN_CONTRACT,LOTTERY_ABI, TOKEN_ABI} from "../constants";
...
export default function Home() {
  ...
  const getEtherBalance = async (provider:any, address:any, contract = false) => {
    try {
  ...
  return (
    <>
      ...
      <h1 className='text-center py-3 mx-5 pt-5'> ENCODE BOOTCAMP LOTTERY</h1><br />
...
<div className="card text-center mx-5">
  ...
  <div className="card-body">
    <label htmlFor="">Tickets(more tickets=better <br /> chance to win): </label>
    <input placeholder='enter amount of tickets' className='form-control' type="number" />
...
<div className="card text-center mx-5">
  ...
  <div className="card-body">
    <label htmlFor="">Amount: </label>
    <input placeholder='swap back ETH' className='form-control' type="number" />
    <button className="btn btn-dark btn-md mt-2">Buy</button>
  </div>
  <div className="card-footer text-muted">
   pay in T11
  ...
  <div className="card-body">
    ...
    <input placeholder='Time in seconds' className='form-control' type="number" />
